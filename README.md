...
- generate WeChat cover and Xiaohongshu poster prompts when explicitly requested
...
v1 focuses on mature copywriting and fact safety. v2 adds explicit WeChat HTML layout generation from the complete WeChat article. v3 adds visual material prompts for covers and posters.
